...
run_py "scripts/history/append_game_line_model_history.py" "append_game_line_model_history.py" || echo "WARNING: append game line model history failed"
...
run_py "scripts/site/inject_schedule_line_history_tab.py" "inject_schedule_line_history_tab.py" || echo "WARNING: schedule line history tab injection failed"
