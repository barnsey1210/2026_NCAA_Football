(async()=>{
  ...
  if(!target)return;
  try{
    const data=await fetch('data/site/futures_view.json?v=20260904T022410Z').then(r=>r.json());
    ...
    section.innerHTML=`<div class="head"><h2>Research — playoff markets</h2><a href="futures.html">Open Playoffs</a></div>
