...
1. fresh The Odds API,
2. fresh SportsGameOdds,
...
## Odds provider priority update (completed 2026-08-11)

The canonical current-market contract now treats The Odds API as the primary current sportsbook odds provider. SportsGameOdds remains supported as a secondary provider and coverage fallback. Source selection remains quote-level rather than game-level so missing books or markets can be filled independently.
