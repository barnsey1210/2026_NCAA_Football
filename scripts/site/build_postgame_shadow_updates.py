...
def main():
    ...
    ap.add_argument("--results", default="data/canonical/game_results_2026.json")
    ...
    if not result_path.exists():
        ...
        if synthetic and not args.allow_synthetic:
            ...
            if result_path.suffix.lower() == ".json":
                ...
                results = result_payload.get("games", [])
            else:
                with result_path.open(newline="", encoding="utf-8-sig") as f:
