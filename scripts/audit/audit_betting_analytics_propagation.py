...
def main():
 ...
 checks={
  ...
  'central_contract':cfg['contracts']['historical_betting_analytics']['artifact']=='data/site/historical_betting_analytics_v2.json' and cfg['contracts']['historical_betting_explorer']['artifact']=='data/site/historical_betting_explorer_v1.json','performance_v5':p['schema_version']=='model-performance-view-v5'}
