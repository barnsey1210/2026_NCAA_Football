...
def main():
 ...
 checks={
  ...
  'page_markers':all(x in page for x in ['historicalResearchView','historicalBettingResearch','historicalDecayPanel','decayMetric','betting_analytics.js','Beat Close','AVG CLV']),
  'central_contract':cfg['contracts']['historical_betting_analytics']['artifact']=='data/site/historical_betting_analytics_v2.json' and cfg['contracts']['historical_betting_explorer']['artifact']=='data/site/historical_betting_explorer_v1.json','performance_contract':p['schema_version'] in {'model-performance-view-v6','model-performance-view-v7','model-performance-view-v8'}}
