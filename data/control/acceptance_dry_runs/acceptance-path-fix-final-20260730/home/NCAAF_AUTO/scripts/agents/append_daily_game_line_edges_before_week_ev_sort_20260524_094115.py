...
def main():
    ...
    if not new_rows.empty:
        new_rows = new_rows.sort_values("score", ascending=False).head(MAX_GAME_ROWS)
    ...
    if not new_rows.empty:
        print(new_rows[["title", "projected_line", "book", "opening_line", "last_move_date", "grade", "score", "reason"]].to_string(index=False))
