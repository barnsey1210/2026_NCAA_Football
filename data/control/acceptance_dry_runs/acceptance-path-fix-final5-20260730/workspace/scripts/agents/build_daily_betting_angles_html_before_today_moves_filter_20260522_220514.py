...
def main() -> None:
    ...
    if not moves.empty and "snapshot_latest" in moves.columns:
...
<body>
  <div class="wrap">
    ...
    <div class="summary">
      ...
      Current arbitrage and middle opportunities are included after the move section.
    </div>
    <div class="subline">
      Market moves in this report: {move_count} · Current inefficiencies: {arb_count}
    </div>
...
"""
    ...
    print(f"Wrote {OUT}: {move_count} market moves, {arb_count} inefficiencies")
